/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 0a1b1531b9de8781ecea601cdb9244be)
...
declare namespace NodeJS {
  interface ProcessEnv extends StringifyValues<
    Pick<
      Cloudflare.Env,
      'ENVIRONMENT' | 'APP_VERSION' | 'BUILDER_ORIGIN' | 'STAGING_REPOSITORY' | 'PRODUCTION_ENABLED'
    >
  > {}
}
