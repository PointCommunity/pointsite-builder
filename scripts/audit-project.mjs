...
async function main() {
  ...
  if (!/^[A-Za-z0-9-]+$/.test(profile.project.owner))
    throw new Error('project.owner is not a GitHub login');
  ...
  // Validate upstream field/workflow structure against this adopter's private Project identity.
