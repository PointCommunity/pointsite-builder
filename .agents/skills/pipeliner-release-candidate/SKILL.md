...
Builder specialization: this application has no review, staging or native release environment. Do not run candidate deployment here. Use the Builder review and direct-production skills under the root operating contract; PointSite Staging is a separate product publication target. Framework maintenance never deploys either application.
