...
description: 'Perform a read-only health audit of the PointSite Builder Issue pipeline, PR linkage, CI, git identity, Cloudflare deployment, and live production runtime.'
---
...
2. Verify live git branch/head, remote `main`, open Issues, active assignment, workflow PR linkage, available metadata, and exact GitHub Quality state. Dependabot PRs are reported separately and do not consume the active Issue slot.
...
Never change Issues, PRs, assignments, labels, Git, Cloudflare, D1, Builder data, or public PointSite state from this skill.
